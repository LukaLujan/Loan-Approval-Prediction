This is not a finished project. There are two files. First code is in english language. The code here there for future work and for showing propose . There are no comments, and code is in raw format. 
